...
const HomePage = () => {
  return (
    <div>
      ...
      <div className="mt-16 ml-16">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold text-gray-800">Exclusive Offers</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-2xl font-semibold text-gray-800">Flexible Payment</h3>
            <p className="mt-4 text-gray-600">
      ...
      {/* Image Section */}
      <div className="mt-16 ml-16 max-w-5xl">
        <img
